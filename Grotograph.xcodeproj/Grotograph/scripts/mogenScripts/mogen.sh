...
#echo mogenerator --model \"${INPUT_FILE_PATH}\" --output-dir \"${INPUT_FILE_DIR}/Model/Entities\" --base-class $baseClass
#mogenerator --model "${INPUT_FILE_PATH}" --output-dir "${INPUT_FILE_DIR}/Model/Entities" --base-class $baseClass
