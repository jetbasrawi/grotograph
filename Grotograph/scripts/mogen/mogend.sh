...
echo mogenerator --model \"${INPUT_FILE_PATH}/$curVer\" --output-dir \"${INPUT_FILE_DIR}/Model/Entities\"
mogenerator --model "${INPUT_FILE_PATH}/$curVer" --output-dir "${INPUT_FILE_DIR}/Model/Entities"
